document.addEventListener("DOMContentLoaded", () => {
    ...
    if (toggleRegPassword) {
        toggleRegPassword.addEventListener("click", () => {
            const type =
                regPasswordField.getAttribute("type") === "password"
                    ? "text"
                    : "password";
        ...
        const winners = [
            {
                ...
                location:
                    "Leverage our advanced analysis to get the most accurate and reliable AU Lotto predictions. Increase your chances of winning with data-driven insights tailored for the Australian lottery.",
            ...
            },
            {
                ...
                location:
                    "Stay updated with the latest AU Lotto results delivered promptly. Never miss a draw and check winning numbers instantly after each draw.",
            ...
            },
            {
                ...
                location:
                    "Receive real-time alerts for the biggest jackpots and prize updates in AU Lotto. Be the first to know about massive jackpots and special draw events.",
            ...
            },
            {
                ...
                location:
                    "New to AU Lotto? Our comprehensive guide covers how to play, ticket purchasing options, and claiming prizes. Perfect for beginners and seasoned players alike.",
            ...
            },
            {
                ...
                location:
                    "Buy your AU Lotto tickets safely and conveniently through our trusted platform. Enjoy seamless transactions with guaranteed ticket authenticity for every draw.",
                ...
                slide.innerHTML = `
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-transform hover:scale-105 h-full">
                        ...
                        <div class="p-6 text-center">
                            <h3 class="text-xl max-md:text-2xl font-bold text-[#00539CFF] mb-1">${winner.name}</h3>
    ...
    function initFaqAccordion() {
        const faqs = [
            {
                question:
                    "How do I play the lottery on pokielvictoriatatts.com?",
                answer: "Playing is easy! Simply create an account, select your preferred lottery game, choose your numbers or opt for a quick pick, and complete your purchase. Your tickets will be stored in your account, and you'll be notified if you win.",
            },
            {
                question:
                    "Is pokielvictoriatatts.com a legitimate and secure platform?",
                answer: "Yes, pokielvictoriatatts.com is fully licensed and regulated by the appropriate Australian gambling authorities. We use industry-standard encryption to protect your personal and financial information, and all transactions are secure.",
            },
            {
                question: "How will I receive my winnings?",
                answer: "Winnings are automatically credited to your account. For smaller amounts, you can withdraw directly to your registered payment method. For larger jackpots, our team will contact you to arrange the payment process according to your preferences and local regulations.",
            },
            {
                question: "Can I play from outside Australia?",
                answer: "Our services are primarily designed for Australian residents. International players should check their local laws regarding online lottery participation before playing, as regulations vary by country and region.",
            },
        ];
